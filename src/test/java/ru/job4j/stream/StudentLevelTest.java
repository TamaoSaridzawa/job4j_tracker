...
public class StudentLevelTest {
    ...
    public void whenSorted() {
        ...
        input.add(new Student1(28, "Masha"));
        input.add(new Student1(128, "Pety"));
        List<Student1> expected = List.of(
                new Student1(128, "Pety"),
                new Student1(28, "Masha")
        );
    ...
    public void whenHasNull() {
        List<Student1> input = new ArrayList<>();
        input.add(null);
        input.add(new Student1(28,"Pety"));
        List<Student1> expected = List.of(new Student1(28,"Pety"));
